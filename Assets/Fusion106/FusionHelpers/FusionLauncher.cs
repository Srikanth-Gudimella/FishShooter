...
namespace Fusion106
{
	...
	public class FusionLauncher : MonoBehaviour, INetworkRunnerCallbacks
	{
		...
		public void SetConnectionStatus(ConnectionStatus status, string message)
		{
			...
			{
				Debug.LogError("------- _connectionCallback");
		...
		public void OnConnectedToServer(NetworkRunner runner)
		{
			...
			{
				Debug.Log("-------- Shared Mode - Spawning Player InstantiatePlayer call from onConnectedToServer");
		...
		public void OnPlayerJoined(NetworkRunner runner, PlayerRef player)
		{
			if (runner.IsServer)
			{
				Debug.Log("----------- OnPlayerJoined Hosted Mode - Spawning Player");
...
//			SetConnectionStatus(ConnectionStatus.Connected, "");
		...
		private void InstantiatePlayer(NetworkRunner runner, PlayerRef playerref)
		{
			...
			{
				Debug.LogError("------- SpawnWorldCallback");
				_spawnWorldCallback(runner);
				_spawnWorldCallback = null;
			}

				Debug.LogError("------- SpawnPlayerCallback InstantiatePlayer");
