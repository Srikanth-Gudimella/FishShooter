    ...
    public class F3DFXController : MonoBehaviour
{
    ...
    {
        Debug.Log("---- Fire type="+DefaultFXType);
        ...
        switch (DefaultFXType)
        {
            ...
            case F3DFXType.PlasmaBeam:   
                ...
                PlasmaBeam();
               //spawnItem= F3DPool.instance.Spawn(plasmaBeam, CanonController.Instance.BulletInitPos[0].position, CanonController.Instance.LaserAngleTransform.rotation, CanonController.Instance.CanonPivot);
    ...
    void PlasmaBeam()
    {
        ...
        //F3DPool.instance.Spawn(plasmaBeam, CanonController.Instance.CanonPivot.position, CanonController.Instance.LaserAngleTransform.rotation, CanonController.Instance.CanonPivot);
    }
