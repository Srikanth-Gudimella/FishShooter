...
[RequireComponent(typeof(LineRenderer))]
    public class F3DBeam : MonoBehaviour
    {
        ...
        public RaycastHit hitPoint;            // Raycast structure
        ...
        void Raycast()
        {
            ...
            //{
                // Get current beam length and update line renderer accordingly
                beamLength = Vector3.Distance(transform.position, TargetPoint);
                lineRenderer.SetPosition(1, new Vector3(0f, 0f, beamLength));
            ...
            // Adjust impact effect position
            if (rayImpact)
                rayImpact.position = TargetPoint;// - transform.forward * 0.5f;
            //}
